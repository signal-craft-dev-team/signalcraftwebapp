...
import signalCraftLogo from '@/assets/signalcraft-text-logo.png';
...
export function Header() {
    ...
    return (
        <>
            <header className="flex items-center p-4 justify-between sticky top-0 z-40 border-b border-slate-100"
            ...
            >
                ...
                >
                    <img
                        ...
                        style={{ filter: 'drop-shadow(0 0.5px 0.5px rgba(0,0,0,0.35))' }}
                        aria-hidden="true"
                    />
                </Link>
